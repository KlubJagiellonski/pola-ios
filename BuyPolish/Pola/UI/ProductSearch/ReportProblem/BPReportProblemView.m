...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _helpLabel.text = NSLocalizedString(@"Report help", nil);
        ...
        _photoTitleLable.text = NSLocalizedString(@"photos:", nil);
        ...
        _descriptionTitleLabel.text = NSLocalizedString(@"description (optional):", nil);

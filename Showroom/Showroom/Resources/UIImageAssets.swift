...
enum Asset: String {
  ...
  case Ic_heart_big = "ic_heart_big"
  case Ic_heart_filled_big = "ic_heart_filled_big"
  case Ic_home = "ic_home"
  case Ic_home_selected = "ic_home_selected"
  case Ic_info = "ic_info"
  case Ic_info_big = "ic_info_big"
  ...
  case Platform_4 = "platform_4"
  case Platform_5 = "platform_5"

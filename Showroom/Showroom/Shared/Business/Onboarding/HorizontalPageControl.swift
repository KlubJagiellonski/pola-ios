...
class HorizontalPageControl: UIView {
    ...
    override func layoutSubviews() {
        ...
        for shapeLayer in circleShapeLayers {
            ...
            dotFrame = CGRectOffset(dotFrame, dotDiameter + dotMargin, 0)
        }
    }
    
    override func intrinsicContentSize() -> CGSize {
        let width = dotDiameter * CGFloat(numberOfPages) + dotMargin * CGFloat(numberOfPages - 1)
        return CGSizeMake(width, dotDiameter)
    }

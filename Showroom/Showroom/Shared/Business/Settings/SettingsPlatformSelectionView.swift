...
protocol SettingsPlatformSelectionViewDelegate: class {
...
class SettingsPlatformSelectionView: UIView {
    ...
    weak var delegate: SettingsPlatformSelectionViewDelegate?
    ...
    func didTapPolishButton(sender: UIButton!) {
        delegate?.settingsPlatformSelectionViewDidTapPolish(self)
    }
    
    func didTapGermanButton(sender: UIButton!) {
        delegate?.settingsPlatformSelectionViewDidTapGerman(self)
    }

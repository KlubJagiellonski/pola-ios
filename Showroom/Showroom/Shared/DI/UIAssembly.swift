...
class UIAssembly: AssemblyType {
    func assemble(container: Container) {
        ...
        container.register(RootModel.self) { r in
            return RootModel(with: r.resolve(UserManager.self)!, apiService: r.resolve(ApiService.self)!, rateAppManager: r.resolve(RateAppManager.self)!, notificationManager: r.resolve(NotificationsManager.self)!, versionManager: r.resolve(VersionManager.self)!, platformManager: r.resolve(PlatformLanguageManager.self)!)
        }
        ...
        container.register(PlatformSelectionViewController.self) { r in
            return PlatformSelectionViewController(platformManager: r.resolve(PlatformLanguageManager.self)!)
        }
